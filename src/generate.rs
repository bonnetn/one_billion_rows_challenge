...
pub fn generate_samples(path: &Path) -> Result<()> {
    ...
    for i in 0_i32..BILLION {
        ...
        if i % 10_000_000_i32 == 0_i32 {
            let percentage = f64::from(i) / f64::from(BILLION) * 100.0_f64;
            println!(
...
impl WeatherStation {
    fn new(name: &'static str, temperature: f64) -> Self {
        let normal = Normal::new(temperature, 10.0_f64).expect("valid normal params");
        Self { name, normal }
    }
